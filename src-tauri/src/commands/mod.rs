use crate::models::{AspectRatio, MediaItem, Preferences, Project, ProjectSummary, Template};
use chrono::Utc;
...
fn get_templates_path(app: &AppHandle) -> PathBuf {
    app.path()
        .app_data_dir()
        .expect("Failed to get app data dir")
        .join("templates.json")
...
// ============ Template Commands (App-level, shared across projects) ============
