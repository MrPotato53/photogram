...
interface DockedLayersPanelProps {
  children: ReactNode;
}
...
export function DockedLayersPanel({ children }: DockedLayersPanelProps) {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      // Dragging left grows width (panel is on the right edge)
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-0 top-0 w-1.5 h-full cursor-ew-resize hover:bg-blue-500/30 transition-colors z-10"
